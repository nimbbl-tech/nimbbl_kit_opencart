...
class Request
{
    ...
    * @param  string|null $token Optional authentication token
    ...
    private function extractOrderIdFromRequest($requestData, $requestBody)
    {
    ...
    private function sanitizeSubMerchantIdForLog($value)
    {
        if ($value === null) {
            return null;
        }
    ...
    private function sanitizeOrderIdForLog($value)
    {
        if (!is_string($value)) {
            return null;
        }
     ...
     */
    private function extractUriPath($url)
    {
