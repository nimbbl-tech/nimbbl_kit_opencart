...
class ControllerExtensionPaymentNimbbl extends Controller {
	...
	public function init()
	{
		...
		$this->nimbbl_api = new NimbblApi($this->publickey, $this->privatekey, $this->endpoint, 'v3');
	}
	...
	private function process_nimbbl() {	
		...
		$newOrder = $this->nimbbl_api->order->create($arg_order_data, 'v3');
		if ($newOrder->error) {
			return [
